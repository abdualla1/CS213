...
Template
bool Word<T> :: update_board(int x, int y, T symbol)
{
...
Template
void Word<T> :: load_dictionary(const string &filename)
{
...
Template
bool Word<T> :: is_word(const string &word) {
